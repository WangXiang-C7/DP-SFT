...
def main():
    ...
    config = {
        ...
        "target_delta": 1e-5,         # δ值（通常设为1/训练集大小）
    ...
    # 1. 准备数据集
    sst2_datasets, tokenizer, collator = prepare_datasets(
    ...
    # ===== 4. 初始化差分隐私引擎 =====
    # 获取数据集大小
    train_size = len(sst2_datasets["train"])
    total_steps = train_size // config["batch_size"]
    # 使用Opacus内置方法计算噪声乘子
    ...
    # 6. 训练模型
    print("Starting DP-LoRA fine-tuning...")
